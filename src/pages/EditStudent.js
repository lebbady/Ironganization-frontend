...
class EditStudent extends Component {
  ...
  handleFormSubmit = (event) => {
    ...
    StudentService.editStudent({ name, surname, preworkStatus,preworkLevel, projectDifficulty, projectQuality, projectDeployLink, projectPresentationLink, cohortId  }, this.props.match.params.studentId)
      .then(() => {
        this.setState({
          name:"",
          surname:"",
    ...
    return (
      <div className="create-student-profile">
        ...
        <form onSubmit={this.handleFormSubmit}>
          ...
          <p><input className="button-wide button" type="submit" value="Edit New Student" /></p>
        </form>
      </div>
    );
  }
